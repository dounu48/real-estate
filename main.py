...
param = {
  ...
  'sortCd' : 'RANK', #RANK, RECNT
  'ptpNo': 1,
  'order' : 'point_' #point 랭킹순, prc 가격순, 최신순 date, 면적순 spc
}
...
while True :
  ...
  excel_header = ['type', 'building', '호수', 'price', 'min_price', 'max_price', 'realtor', 'cnt_realtor']
  excel_result = []
  ...
  csvfile = open('./%s_bldg_code.csv' %time, 'w')
